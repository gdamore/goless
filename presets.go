...
var DarkPreset = Preset{
	...
	Chrome: Chrome{
		...
		LineNumberStyle:  tcell.StyleDefault.Foreground(solarizedBase01).Background(solarizedBase03).Dim(true),
...
var LightPreset = Preset{
	...
	Chrome: Chrome{
		...
		LineNumberStyle:  tcell.StyleDefault.Foreground(solarizedBase1).Background(solarizedBase3).Dim(true),
