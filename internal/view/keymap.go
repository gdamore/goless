...
func lessKeyMap() keyMap {
	return keyMap{
		normal: []keyBinding{
			...
			{key: tcell.KeyRune, rune: "e", mod: tcell.ModCtrl, action: actionScrollDown},
			{key: tcell.KeyRune, rune: "j", mod: tcell.ModCtrl, action: actionScrollDown},
			{key: tcell.KeyRune, rune: "n", mod: tcell.ModCtrl, action: actionScrollDown},
			...
			{key: tcell.KeyRune, rune: "v", mod: tcell.ModAlt, action: actionPageUp},
			{key: tcell.KeyRune, rune: "b", mod: tcell.ModCtrl, action: actionPageUp},
			{key: tcell.KeyRune, rune: "f", mod: tcell.ModCtrl, action: actionPageDown},
			{key: tcell.KeyRune, rune: "v", mod: tcell.ModCtrl, action: actionPageDown},
			...
			{key: tcell.KeyRune, rune: "Q", action: actionQuit},
			{key: tcell.KeyRune, rune: "y", action: actionScrollUp},
